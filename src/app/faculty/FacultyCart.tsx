...
const FacultyCart = ({category,title,description,image,id}) => {
    return (
        <div className="max-w-[330px] sm:max-w-[300px] bg-white border border-black hover:shadow-[-7px_7px_0px_#000000] cursor-pointer">
            ...
            <div className="p-5">
                ...
                <Link href={`/faculty/${id}`} className="inline-flex items-center py-2 font-semibold text-center">
                    Show more <Image src={assets.arrow} className="ml-2" alt="" width={12}/>
                </Link>
            </div>
        </div>
    )
